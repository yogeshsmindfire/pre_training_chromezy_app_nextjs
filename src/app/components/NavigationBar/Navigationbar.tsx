  ...
  return (
    <div className='navbar'>
      ...
      <div className='links'>
        ...
        <div
          className={
            scrollPosition > 600 && scrollPosition < 1370 ? 'active' : ''
          }
        >
          Explore AI
        </div>
        <div
          className={
            scrollPosition > 1370 && scrollPosition < 1900 ? 'active' : ''
          }
        >
          Services
        </div>
        <div
          className={
            scrollPosition > 1900 && scrollPosition < 2860 ? 'active' : ''
          }
        >
          E-Commerce
        </div>
        <div
          className={
            scrollPosition > 2860 && scrollPosition < 3900 ? 'active' : ''
          }
        >
          Products
        </div>
